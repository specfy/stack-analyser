...
export const list: TechItem[] = [
  ...
  { key: 'datadog', name: 'Datadog', type: 'saas' },
  ...
  { key: 'elasticloud', name: 'Elastic Cloud', type: 'saas' },
  ...
  { key: 'newrelic', name: 'New Relic', type: 'saas' },
  ...
  { key: 'pingdom', name: 'Pingdom', type: 'saas' },
  ...
  { key: 'prismacloud', name: 'PrismaCloud', type: 'saas' },
  ...
  { key: 'sentry', name: 'Sentry', type: 'saas' },
