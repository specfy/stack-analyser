...
export const list: TechItem[] = [
  ...
  { key: 'httpd', name: 'Httpd', type: 'tool' },
  ...
  { key: 'nginx', name: 'Nginx', type: 'tool' },
  ...
  { key: 'zookeeper', name: 'Zookeeper', type: 'tool' },
